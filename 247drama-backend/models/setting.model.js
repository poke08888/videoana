...
const settingSchema = new mongoose.Schema(
  {
    ...
    isNotificationTaskEnabled: { type: Boolean, default: true },
    isEmailTaskEnabled: { type: Boolean, default: true },
    isPhoneTaskEnabled: { type: Boolean, default: true },
    isZaloTaskEnabled: { type: Boolean, default: true },
    isFacebookTaskEnabled: { type: Boolean, default: true },
    isYoutubeTaskEnabled: { type: Boolean, default: true },
    isTiktokTaskEnabled: { type: Boolean, default: true },
    isInstagramTaskEnabled: { type: Boolean, default: true },
    isWatchTime10mTaskEnabled: { type: Boolean, default: true },
    isWatchTime15mTaskEnabled: { type: Boolean, default: true },
    isWatchTime20mTaskEnabled: { type: Boolean, default: true },
    
    instagramRewardCoins: { type: Number, default: 50 },
    zaloRewardCoins: { type: Number, default: 50 },
    zaloLink: { type: String, default: "" },
    facebookRewardCoins: { type: Number, default: 50 },
    facebookLink: { type: String, default: "" },
    youtubeRewardCoins: { type: Number, default: 50 },
    youtubeLink: { type: String, default: "" },
    tiktokRewardCoins: { type: Number, default: 50 },
    tiktokLink: { type: String, default: "" },
    notificationRewardCoins: { type: Number, default: 50 },
    emailRewardCoins: { type: Number, default: 50 },
    linkPhoneRewardCoins: { type: Number, default: 50 },
    instagramLink: { type: String, default: "" },
    watchTime10mRewardCoins: { type: Number, default: 50 },
    watchTime15mRewardCoins: { type: Number, default: 50 },
    watchTime20mRewardCoins: { type: Number, default: 50 },
